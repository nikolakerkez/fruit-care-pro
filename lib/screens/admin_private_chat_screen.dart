...
class AdminPrivateChatScreen extends StatefulWidget {
  ...
  final String? chatId;
  final String? userId;
  const AdminPrivateChatScreen({super.key, this.chatId, this.userId});

  @override
  _AdminPrivateChatScreenState createState() => _AdminPrivateChatScreenState();
}
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      File imageFile = File(pickedFile.path);
          chatService.sendMessage(chatId, adminId, userId, "", imageFile);
      }
  }
                ...
                builder: (ctx, chatSnapshot)
                {
                  if (chatSnapshot.connectionState == ConnectionState.waiting ||
                    chatSnapshot.connectionState == ConnectionState.none) {
                      ...
                      : Center(
                          child: Text("Startuj konverzaciju."),
                        );
                   }else {
        ...
        child: IntrinsicWidth(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: chatData['senderId'] == userId
                  ? Colors.orangeAccent[400]
                  : Colors.green[800],
              borderRadius: BorderRadius.circular(12),
            ),
            child: Column(
              crossAxisAlignment: chatData['senderId'] == userId
